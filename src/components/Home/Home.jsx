    ...
    return (
        <div>
            <div className='home-photos lg:w-4/5 sm:w-3/4'>
                ...
                <p className='text-2xl pt-8 font-semibold text-slate-100'>Answer the questions on our website to test your knowledge, <br /> and let your knowledge be tested.</p>
                <p className='text-xl text-slate-100'>You can take tests on multiple subjects here, and you can easily check the <br /> knowledge you have learned.</p>
            </div>
